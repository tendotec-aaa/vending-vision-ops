-- Update the process_visit_report_inventory function to use new machine_toy_movements schema
...
BEGIN
    ...
    LOOP
        ...
        -- Update machine_toy_slots with new stock
        ...
        -- Update products inventory if product_id exists
        IF (slot_item->>'product_id') IS NOT NULL THEN
            UPDATE public.products
            SET 
                quantity_bodega = quantity_bodega - v_units_refilled,
                quantity_in_machines = quantity_in_machines - v_units_sold + v_units_refilled - v_units_removed,
